...
export const en = {
  ...
  // mode's action bar — so their labels and every toast the shared handlers in
  // src/item-actions.js raise are shared chrome, not one screen's copy. The
  // aria-labels stay per screen on purpose: a card in a column of sixty has to
  // name its Item, and the Reader, showing one, must not.
  "app.save": "Save",
  "app.saved": "Saved",
  "app.share": "Share",
  "app.savedToast": "Saved. This Item and its Article are never removed.",
  "app.unsavedToast": "Removed from Saved.",
  "app.saveFailed": "That could not be saved.",
  "app.shareCopied": "Link copied.",
  "app.shareFailed": "The link could not be shared.",
...
export const it = {
  ...
  "app.unsavedToast": "Rimosso dai salvati.",
  "app.saveFailed": "Non è stato possibile salvare.",
  "app.shareCopied": "Link copiato.",
  "app.shareFailed": "Non è stato possibile condividere il link.",
